...
const ColorGamuts_1 = require("./ColorGamuts");
...
class Light extends BridgeObjectWithId_1.BridgeObjectWithId {
    constructor(id) {
        super(ATTRIBUTES, id);
    ...
    get colorGamut() {
        if (this.mappedColorGamut && this.mappedColorGamut !== '2200K-6500K') {
            return ColorGamuts_1.getColorGamut(this.mappedColorGamut);
        }
        else {
            return null;
        }
